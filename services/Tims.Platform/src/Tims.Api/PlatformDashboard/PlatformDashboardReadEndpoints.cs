...
/// would be an improvement, and improvements make step-5 parity uninterpretable. (PR 3's port of
/// <c>getDashboardKpis</c> drops that cache DELIBERATELY, which is a divergence rather than fidelity —
/// see <see cref="PlatformDashboardFxUseCase"/> for the argument and who decided it.)</para>
///
