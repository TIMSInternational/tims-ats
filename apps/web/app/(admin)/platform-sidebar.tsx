...
function useNavSections() {
  ...
  return [
    { label: null, items: [{ href: '/dashboard', label: t.nav.dashboard, icon: 'grid' }] },
    {
      label: ps.platform,
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/platform/access-review', label: ps.accessReview, icon: 'shield' },
...
function Icon({ name, className }: { name: string; className: string }) {
  ...
  switch (name) {
    ...
    case 'users':
      return (
        <svg className={c} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
          <path d="M15 19c0-2.21-2.686-4-6-4s-6 1.79-6 4" />
          <circle cx="9" cy="9" r="3.5" />
          <path d="M20 19c0-1.657-1.343-3-3-3-.825 0-1.572.336-2.112.879" />
    ...
    case 'headset':
      return (
        <svg className={c} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
          <path d="M20 16v-6a8 8 0 10-16 0v6" />
          <path d="M4 16a2 2 0 01-2-2v-2a2 2 0 012-2h1v6H4zM20 16a2 2 0 002-2v-2a2 2 0 00-2-2h-1v6h1z" />
          <path d="M18 20a2 2 0 01-2 2h-3" />
        </svg>
      );
    case 'receipt':
      return (
        <svg className={c} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
          <path d="M3 3h18v18l-2-1.5L17 21l-2-1.5L13 21l-2-1.5L9 21l-2-1.5L5 21l-2-1.5V3z" />
...
export function PlatformSidebar({
  ...
  return (
    ...
    >
      {/* Logo bar */}
      <div
        className={`flex items-center justify-between shrink-0 ${expanded ? 'px-3.5 py-3' : 'px-1.5 py-3 justify-center'}`}
      >
