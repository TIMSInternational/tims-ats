...
export default function SubscriptionsPage() {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden p-6">
        ...
        {kpis.isLoading ? (
          ...
          <>
            ...
            <div className="bg-white rounded-xl shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-5 border border-amber-200">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs text-[#8B8B8B] font-medium uppercase tracking-wide">Trials por Vencer</span>
                ...
                return (
                  <div key={i} className="flex-1 flex flex-col items-center gap-1.5">
                    ...
                    <div
                      ...
                      style={{
                        height: `${heightPct}%`,
                        backgroundColor: m.mrr === 0 ? '#EDEDED' : isLast ? '#22c55e' : `rgba(34, 197, 94, ${0.2 + (i / 5) * 0.8})`,
                      }}
                    />
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className="text-xs text-[#585858]">{status === 'trialing' ? '\u2014' : 'Mensual'}</span>
                      </td>
                      <td className="px-4 py-3">
      ...
      {/* Trials por Vencer Alert — only shows when there are expiring trials */}
      {kpis.data && kpis.data.expiringTrials.length > 0 && (
        <div className="bg-white rounded-xl shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-5 border border-amber-200 mt-5 flex-shrink-0">
          ...
          <div className="space-y-3">
            {kpis.data.expiringTrials.map((trial) => {
              ...
              return (
                <div key={trial.id} className="flex items-center justify-between p-3 rounded-lg bg-amber-50">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => handleExtendTrial(trial.organizationId)}
                      disabled={updateSub.isPending}
