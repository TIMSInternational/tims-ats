    ...
    <div className="flex flex-col flex-1 min-w-0 h-full">
      ...
      <div className="flex items-center justify-between px-6 h-16 bg-white border-b border-[#EDEDED] shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => toast('Configurar Alertas: proximamente', { type: 'info' })} className="flex items-center gap-1.5 bg-[#DD0C15] text-white px-4 h-8 rounded-lg text-[12px] font-medium">
