...
| 3   | Tests (vitest)                 | `npx vitest run` (expect **2636 passing across 283 files** as of 2026-08-03; more is fine, fewer is a failure). Bump this when you add tests — a stale anchor makes "fewer is a failure" unenforceable, the same defect class as a gate that cannot fail.                                                                                                                                                                                                                                                                                                                      |
