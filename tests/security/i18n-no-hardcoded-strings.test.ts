...
const KNOWN_DEBT = new Set<string>([
  ...
  'apps/web/app/(admin)/platform/organizations/[id]/sections/billing-section.tsx:101:jsx-text',
  'apps/web/app/(admin)/platform/organizations/[id]/sections/billing-section.tsx:104:jsx-text',
