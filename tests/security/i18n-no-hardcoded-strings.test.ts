...
const KNOWN_DEBT = new Set<string>([
  ...
  'apps/web/app/(admin)/people/performance/feedback-panel.tsx:135:jsx-text',
  'apps/web/app/(admin)/people/performance/feedback-panel.tsx:185:jsx-text',
  ...
  'apps/web/app/(admin)/platform/organizations/[id]/sections/billing-section.tsx:105:jsx-text',
  ...
  'apps/web/app/(admin)/platform/users/invite-wizard.tsx:175:jsx-text',
  'apps/web/app/(admin)/platform/users/invite-wizard.tsx:191:jsx-text',
  ...
  'apps/web/app/(admin)/recruitment/interviews/schedule-modal.fields.tsx:176:ternary',
  ...
  'apps/web/app/(admin)/talent/succession/exit-simulator.tsx:108:ternary',
  'apps/web/app/(admin)/talent/succession/exit-simulator.tsx:124:ternary',
]);
