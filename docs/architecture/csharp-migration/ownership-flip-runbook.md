...
on 2026-08-10 — see §7's CORRECTION; this sentence previously cited only the 2026-07-29 date and was
...
> while, in its own next sentence, listing `packages/db/prisma/seed-demo.ts:1207,1226` as "the only
...
> the `ON CONFLICT` clause mutation-proved (removing it reproduces `23505`).

The remaining write-shaped hit is a comment at `apps/web/lib/platform-api/engagement.ts:433`.
...
| `packages/db/prisma/seed-demo.ts:2206,2212,2231` (was `:1202,1207,1226`)        | `survey.findFirst` / `.create` / `surveyResponse.create`                                                                      | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | **DONE 2026-08-10 — ported to raw SQL.** These two `.create`s were the whole of #64's §0 P1 blocker set; see §7's CORRECTION. Now `$queryRaw`/`$executeRaw` at `:2206-2268`                                                                                                                                                                                                                                                                                |
