...
- **Truth-up 2026-07-29: 12 of the ~20 `NEXT_PUBLIC_*_VIA_CSHARP` flags are now flipped and live in
  ...
  respective slice docs). TS-code deletion (step 7) has now happened for 4 of the now-12 live
  read/write surfaces — reporting and evaluation360 (2026-07-28), and team-intel and billing-usage
  (2026-07-29) — the remaining live surfaces (succession, nine-box, compensation, engagement write)
